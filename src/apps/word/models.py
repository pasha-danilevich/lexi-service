...
class UserWord(models.Model):
    user = models.ForeignKey("user.User", related_name='word_related_with_user', on_delete=models.CASCADE, blank=False, null=False)
    word = models.ForeignKey("word.Word", related_name='user_related_with_word', on_delete=models.CASCADE, blank=False, null=False)
